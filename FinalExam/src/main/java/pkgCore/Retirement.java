...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		pmt = FinanceLib.pmt(dAnnualReturnWorking/12, iYearsToWork*12, 0, TotalAmountToSave(), false);
		return pmt;
	}
	...
	public double TotalAmountToSave() {
		...
		double pv = 0;
		pv = FinanceLib.pv(dAnnualReturnRetired/12, iYearsRetired*12, dRequiredIncome - dMonthlySSI, 0, false);
